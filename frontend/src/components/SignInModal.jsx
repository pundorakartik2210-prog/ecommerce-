          ...
          <div className="auth-split-visual-panel">
            ...
            <div style={{ zIndex: 1, paddingRight: '20px' }}>
              <div style={{ fontSize: '15px', fontStyle: 'italic', opacity: 0.85, lineHeight: '1.6', marginBottom: '8px' }}>
                "Harvested with care, delivered to your doorstep. Experience the power of pure, organic living."
              </div>
          ...
          <div className="auth-split-form-panel">
            ...
            >
              <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                ...
                >
                  {/* Reverted back to the original user avatar icon */}
              ...
              <div style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: 'var(--text-secondary)', fontWeight: '500' }}>
