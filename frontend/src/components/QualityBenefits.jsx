      ...
      <div className="benefits-grid">
        <div className="benefit-card roasted">
          <div className="benefit-icon-wrapper">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="benefit-svg">
              <circle cx="12" cy="12" r="10"></circle>
              <path d="M12 8l4 4-4 4M8 12h8" className="arrow-path"></path>
            </svg>
          </div>
        ...
        <div className="benefit-card protein">
          <div className="benefit-icon-wrapper">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="benefit-svg">
              ...
              <line x1="6" y1="1" x2="6" y2="4" className="steam-line steam-line-1"></line>
              <line x1="10" y1="1" x2="10" y2="4" className="steam-line steam-line-2"></line>
              <line x1="14" y1="1" x2="14" y2="4" className="steam-line steam-line-3"></line>
            </svg>
          </div>
        ...
        <div className="benefit-card pure">
          <div className="benefit-icon-wrapper">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="benefit-svg">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" className="shield-path"></path>
            </svg>
          </div>
