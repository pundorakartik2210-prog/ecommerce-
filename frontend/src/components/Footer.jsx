...
const PRODUCT_FOOTER_DEFAULTS = {
  "pb-classic-creamy": {
    className: "shop-icon-creamy",
    icon: (
    ...
    shortName: "Classic Creamy"
  },
  "pb-classic-crunchy": {
    className: "shop-icon-crunchy",
    icon: (
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="policy-icon">
        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
      </svg>
    ),
    shortName: "Classic Crunchy"
  },
  "pb-extra-crunchy": {
    className: "shop-icon-crunchy",
    icon: (
    ...
    shortName: "Extra Crunchy"
  },
  "pb-dark-chocolate": {
    className: "shop-icon-choco",
    icon: (
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="policy-icon">
        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
      </svg>
    ),
    shortName: "Chocolate Smoothy"
  },
  "pb-high-protein": {
    className: "shop-icon-protein",
    icon: (
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="policy-icon">
...
export default function Footer({ products = [], onPolicyClick, onTrackClick, onAboutClick }) {
  return (
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="footer-links">
              {products.map(prod => {
                const defaults = PRODUCT_FOOTER_DEFAULTS[prod.id] || TYPE_DEFAULTS[prod.type] || TYPE_DEFAULTS.creamy;
                const displayName = defaults.shortName || prod.name;
                return (
                  <li key={prod.id}>
                    <a href="#products-catalog" className="footer-icon-link policy-link">
                      <span className={`policy-icon-container ${defaults.className}`}>
                        {defaults.icon}
                      </span>
